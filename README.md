...
| paramlogin_key                  | false     |                    | Credentials.                                                                                                                                                                                                                                                                                       |
| paramlogin_value                | false     |                    | Credentials.                                                                                                                                                                                                                                                                                       |
| headerlogin_contentType         | false     |                    | Add header Content-type to login request                                                                                                                                                                                                                                                           |
| replace_ipOrigin                | false     |                    | Replace ip origin requests with kong ip                                                                                                                                                                                                                                                            |
| header_request                  | false     | Authorization      | Header where the token will be sent upstream.                                                                                                                                                                                                                                                      |
| login_tls_crt                   | false     | Certificate login  | File .crt for login                                                                                                                                                                                                                                                                                |
| login_tls_key                   | false     | Certificate login  | File .key for login                                                                                                                                                                                                                                                                                |
