return {
  ...
  fields = {
    ...
    username_key = { default = "username", type = "string" },
    username_value = { required = true, type = "string" },
    password_key = { default = "password", type = "string" },
    password_value = { required = true, type = "string" },
    ...
    log_enabled = { default = false, type = "boolean" }
  }
}
